...
.modern-template .hero-wrap {
    background: radial-gradient(circle at top right, rgba(245, 158, 11, 0.2), transparent 55%), radial-gradient(circle at bottom left, rgba(249, 115, 22, 0.3), transparent 60%), #0f172a;
    border-radius: var(--radius);
    padding: 52px;
