...
.modern-template .hero-wrap {
    background: radial-gradient(circle at top left, rgba(34, 211, 238, 0.2), transparent 55%), radial-gradient(circle at bottom right, rgba(167, 139, 250, 0.25), transparent 50%), #0b1120;
    border-radius: var(--radius);
    padding: 52px;
