...
.modern-template .hero-wrap {
    background: radial-gradient(circle at 20% 20%, rgba(99, 102, 241, 0.35), transparent 45%), radial-gradient(circle at 80% 0%, rgba(34, 211, 238, 0.25), transparent 50%), #0f172a;
    border-radius: var(--radius);
    padding: 52px;
