...
.modern-template .hero-wrap {
    background: radial-gradient(circle at top left, rgba(0,0,0,0.2), transparent 60%), var(--surface);
...
.modern-template .price-tag {
    background: transparent; color: var(--text); border: 2px solid var(--primary);
    padding: 12px 22px;
    border-radius: 999px;
    font-weight: 700;
...
.modern-template .order-card .form-select {
    background-color: rgba(0,0,0,0.15); border: 1px solid rgba(255,255,255,0.2); border-radius: 14px;
    color: var(--text);
    padding: 12px 14px;
}
...
.modern-template .btn-accent {
    background: var(--secondary); color: #0f172a; border-radius: 10px;
    border: none;
    font-weight: 700;
    padding: 12px 18px;
