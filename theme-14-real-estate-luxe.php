...
.modern-template .hero-wrap {
    background: linear-gradient(120deg, rgba(0,0,0,0.25), transparent 65%), var(--surface);
    border-radius: var(--radius);
    padding: 44px;
    border-bottom: 3px solid var(--secondary);
    border: 1px solid rgba(255,255,255,0.12); box-shadow: 0 10px 20px rgba(2,6,23,0.2);
}
...
.modern-template .badge {
    background: transparent; color: var(--text); border: 1px solid var(--primary);
    border-radius: 999px;
    padding: 6px 12px;
    font-weight: 600;
}
...
.modern-template .order-card .form-select {
    background-color: rgba(255,255,255,0.2); border: 1px dashed rgba(255,255,255,0.3); border-radius: 12px;
    color: var(--text);
    padding: 12px 14px;
}
...
.modern-template .btn-accent {
    background: transparent; color: var(--text); border: 2px solid var(--primary); border-radius: 8px;
    border: none;
    font-weight: 700;
    padding: 12px 18px;
...
.modern-template .section-alt {
    background: linear-gradient(180deg, rgba(0,0,0,0.15), rgba(0,0,0,0.35)); border: 1px solid rgba(255,255,255,0.1);
    border-radius: var(--radius);
    padding: 38px;
}
