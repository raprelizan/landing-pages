...
.modern-template .price-tag {
    background: linear-gradient(120deg, var(--primary), var(--secondary)); color: #fff;
    padding: 12px 22px;
    border-radius: 999px;
    font-weight: 700;
...
.modern-template .order-card .form-select {
    background-color: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.18); border-radius: 12px;
    color: var(--text);
    padding: 12px 14px;
}
...
.modern-template .section-alt {
    background: linear-gradient(180deg, rgba(255,255,255,0.06), rgba(0,0,0,0.12)); border: 1px solid rgba(255,255,255,0.12);
    border-radius: var(--radius);
    padding: 38px;
}
