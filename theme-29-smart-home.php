...
.modern-template .hero-wrap {
    background: radial-gradient(circle at top, rgba(255,255,255,0.18), transparent 55%), var(--surface);
...
.modern-template .order-card .form-select {
    background-color: rgba(255,255,255,0.16); border: 1px solid rgba(255,255,255,0.25); border-radius: 12px;
    color: var(--text);
    padding: 12px 14px;
}
...
.modern-template .section-alt {
    background: var(--surface); border: 1px dashed rgba(0,0,0,0.1);
    border-radius: var(--radius);
    padding: 38px;
}
