...
.modern-template .hero-wrap {
    background: linear-gradient(135deg, rgba(255,255,255,0.05), rgba(0,0,0,0.15)), var(--surface);
...
.modern-template .price-tag {
    background: var(--surface-soft); color: var(--text); border: 1px solid rgba(0,0,0,0.08);
    padding: 12px 22px;
    border-radius: 999px;
    font-weight: 700;
...
.modern-template .order-card .form-select {
    background-color: rgba(255,255,255,0.1); border: 1px solid rgba(0,0,0,0.12); border-radius: 14px;
    color: var(--text);
    padding: 12px 14px;
}
...
.modern-template .btn-accent {
    background: transparent; color: var(--text); border-bottom: 3px solid var(--primary); border-radius: 0;
    border: none;
    font-weight: 700;
    padding: 12px 18px;
