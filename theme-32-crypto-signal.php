...
.modern-template .hero-wrap {
    background: radial-gradient(circle at top right, rgba(255,255,255,0.18), transparent 55%), var(--surface);
...
.modern-template .price-tag {
    background: rgba(255,255,255,0.08); color: var(--text); border: 1px solid rgba(255,255,255,0.3);
    padding: 12px 22px;
    border-radius: 999px;
    font-weight: 700;
...
.modern-template .feature-card {
    background: rgba(0,0,0,0.08); border: 1px solid rgba(255,255,255,0.2);
    border-top: 3px solid var(--secondary);
...
.modern-template .btn-accent {
    background: linear-gradient(120deg, var(--primary), var(--secondary)); color: #fff; border-radius: 999px;
    border: none;
    font-weight: 700;
    padding: 12px 18px;
