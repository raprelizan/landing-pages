...
.modern-template .hero-wrap {
    background: linear-gradient(120deg, rgba(255,255,255,0.12), transparent 70%), var(--surface);
...
.modern-template .order-card .form-select {
    background-color: rgba(0,0,0,0.2); border: 1px solid rgba(255,255,255,0.2); border-radius: 6px;
    color: var(--text);
    padding: 12px 14px;
}
...
.modern-template .btn-accent {
    background: var(--primary); color: #fff; border-radius: 4px; text-transform: uppercase;
    border: none;
    font-weight: 700;
    padding: 12px 18px;
