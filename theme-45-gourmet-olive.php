...
.modern-template .hero-wrap {
    background: radial-gradient(circle at 20% 20%, rgba(255,255,255,0.2), transparent 50%), var(--surface);
    border-radius: var(--radius);
    padding: 60px;
    outline: 1px solid rgba(255,255,255,0.2); outline-offset: -8px;
    border: 2px solid rgba(255,255,255,0.2); box-shadow: 0 16px 36px rgba(2,6,23,0.28);
}
...
.modern-template .badge {
    background: rgba(255,255,255,0.2); color: var(--text); border: 1px dashed rgba(255,255,255,0.3);
    border-radius: 999px;
    padding: 6px 12px;
    font-weight: 600;
}
...
.modern-template .feature-card {
    background: rgba(255,255,255,0.08); border: 1px solid rgba(0,0,0,0.08);
...
.modern-template .order-card .form-select {
    background-color: transparent; border: 2px solid rgba(255,255,255,0.3); border-radius: 8px;
    color: var(--text);
    padding: 12px 14px;
}
...
.modern-template .btn-accent {
    background: var(--primary); color: #0f172a; border-radius: 16px;
    border: none;
    font-weight: 700;
    padding: 12px 18px;
